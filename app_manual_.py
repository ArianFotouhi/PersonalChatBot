...
only show the SQLite query  for -> assume in {tables_columns_sqlite}, the tables are keys of dictionary and their columns are values.
...
llm = OpenAI(openai_api_key="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")
